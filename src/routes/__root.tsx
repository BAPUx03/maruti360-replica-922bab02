...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Prata&family=Old+Standard+TT:ital,wght@0,400;0,700;1,400&family=Jost:wght@300;400;500&family=Montserrat:wght@300;400;500&display=swap",
      },
